...
enum macdrv_window_messages
{
    ...
    WM_MACDRV_PRESENT_REMOTE_GPU_LAYER,
};
...
extern void macdrv_UpdateLayeredWindow(HWND hwnd, BYTE alpha, BOOL per_pixel_alpha, UINT flags);
...
extern void macdrv_purge_dib_endpoints(HWND hwnd);
