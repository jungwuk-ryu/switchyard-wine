...
extern unsigned int get_fd_sharing( struct fd *fd );
...
extern void lock_fd( struct fd *fd, struct async *async, file_pos_t offset, file_pos_t count,
                     unsigned int key, int shared, int wait );
extern void unlock_fd( struct fd *fd, file_pos_t offset, file_pos_t count, unsigned int key );
...
extern void async_clear_user_apc( struct async *async );
