...
C_ASSERT( offsetof(struct get_process_native_info_reply, cycle_time) == 24 );
C_ASSERT( offsetof(struct get_process_native_info_reply, terminated) == 32 );
C_ASSERT( sizeof(struct get_process_native_info_reply) == 40 );
...
C_ASSERT( offsetof(struct lock_file_request, async) == 16 );
C_ASSERT( offsetof(struct lock_file_request, wait) == 56 );
C_ASSERT( sizeof(struct lock_file_request) == 64 );
C_ASSERT( offsetof(struct lock_file_reply, wait) == 8 );
C_ASSERT( offsetof(struct lock_file_reply, options) == 12 );
C_ASSERT( offsetof(struct lock_file_reply, completed) == 16 );
C_ASSERT( sizeof(struct lock_file_reply) == 24 );
...
C_ASSERT( offsetof(struct unlock_file_request, key) == 32 );
C_ASSERT( sizeof(struct unlock_file_request) == 40 );
